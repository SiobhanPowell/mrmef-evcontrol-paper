...
date = '20240208'
folder = 'Results_AEFMEF_outputs_'+date
if not os.path.isdir(folder):
    os.mkdir(folder)
    
signals_base = pd.read_csv('../Data/signals_df_aef_mef_storagebefore_noevbase_20240208.csv', index_col=0)
...
def run_dispatch_wrapped(save_str, gd, year, signal_here, time_array, date, hourly_signal_weekday=None, hourly_signal_weekend=None, baseyear=2019):
