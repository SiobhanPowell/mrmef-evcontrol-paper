...
date = '20240214'#'20240208'
folder = 'Results_MRMEF_outputs_CO2_'+date 
if not os.path.isdir(folder):
    os.mkdir(folder)
    
signals = pd.read_csv('../Data/signals_df_mrmef_storagebefore_noevbase_co2price_01dolperkg_20240208.csv', index_col=0)
...
def run_dispatch_wrapped(save_str, gd, year, signal_here, time_array, date, baseyear=2019, hourly_signal_weekday=None, hourly_signal_weekend=None, co2_price_dol_per_kg=0.1):
...
for deltaMW in deltaMW_set:
    ...
    for year in year_set:
        ...
        signal_here = None
        dpdfs_all[year] = run_dispatch_wrapped(save_str, gd, year, signal_here, time_array, date, hourly_signal_weekday=signal_here_weekday, baseyear=baseyear, hourly_signal_weekend=signal_here_weekend, co2_price_dol_per_kg=co2_price_dol_per_kg)
