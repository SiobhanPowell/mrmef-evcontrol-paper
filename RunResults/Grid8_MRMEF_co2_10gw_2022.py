...
date = '20240212'
folder = 'Results_MRMEF_outputs_CO2_2022BASE_'+date 
if not os.path.isdir(folder):
    os.mkdir(folder)
    
signals = pd.read_csv('../Data/signals_df_mrmef_storagebefore_noevbase_co2price_01dolperkg_2022BASE_20240212.csv', index_col=0)
...
def run_dispatch_wrapped(save_str, gd, year, signal_here, time_array, date, baseyear=2022, hourly_signal_weekday=None, hourly_signal_weekend=None, co2_price_dol_per_kg=0.1):
