"""
This code is an extension of that posted on https://github.com/SiobhanPowell/speech-grid-impact. This is an extension of the model originally published by Thomas Deetjen : https://github.com/tdeetjen/simple_dispatch. The second class, StorageModel, was written by Siobhan Powell.  The first class, GridModel, was developed with Sonia Martin.
The following classes were written by Thomas Deetjen and adjusted or added to by Siobhan Powell.

The code can be cited: 
